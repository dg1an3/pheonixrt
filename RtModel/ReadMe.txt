========================================================================
    STATIC LIBRARY : RtModel Project Overview
========================================================================

AppWizard has created this RtModel library project for you. 

This file contains a summary of what you will find in each of the files that
make up your RtModel application.
...
StdAfx.h, StdAfx.cpp
    ...
    named RtModel.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "RtModel.rc" and a "RtModel.h" that 
