========================================================================
    STATIC LIBRARY : OptimizeN Project Overview
========================================================================

AppWizard has created this OptimizeN library project for you. 

This file contains a summary of what you will find in each of the files that
make up your OptimizeN application.
...
StdAfx.h, StdAfx.cpp
    ...
    named OptimizeN.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "OptimizeN.rc" and a "OptimizeN.h" that 
