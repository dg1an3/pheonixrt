...
def _conform_to(from_img:itkImageF3, to_img:itkImageF3):
    if (to_img.GetLargestPossibleRegion() != from_img.GetLargestPossibleRegion()
...
def rotate_density_for_beam(beam:dict, md_img:itkImageF3) -> itkImageF3:
    ...
    interpolator = itk.itkLinearInterpolateImageFunctionPython.itkLinearInterpolateImageFunctionICVF33D()
