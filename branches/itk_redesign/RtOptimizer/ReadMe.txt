========================================================================
    STATIC LIBRARY : RtOptimizer Project Overview
========================================================================

AppWizard has created this RtOptimizer library project for you. 

This file contains a summary of what you will find in each of the files that
make up your RtOptimizer application.
...
StdAfx.h, StdAfx.cpp
    ...
    named RtOptimizer.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "RtOptimizer.rc" and a "RtOptimizer.h" that 
